...
<template>
  <div class="p-2 bg-[url(/texture/diagonal-stroke.png)] bg-cover relative bg-center">
    ...
    >{{ props.period }}</h5>
    <div class="absolute left-3 -bottom-3 flex flex-row gap-1">
      <a v-if="props.github" :href="props.github">
        <img src="/logos/github-mark-white.svg" alt="github logo"
             class="w-8 h-8 bg-gray-900 rounded-full p-1 ">
      </a>
      <a v-if="props.website" :href="props.website">
        <img src="/logos/website-mark-white.svg" alt="github logo"
             class="w-8 h-8 bg-gray-900 rounded-full p-1 ">
      </a>
    </div>
  </div>
